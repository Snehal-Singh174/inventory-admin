    ...
    return (
        <div className={cn("relative", className)}>
            ...
            <div className="relative">
                ...
                {/* Dropdown */}
                {isOpen && (
                    <div className="absolute z-50 w-full mt-1 bg-background text-foreground border border-border rounded-md shadow-lg animate-fade-in-down">
                        {searchable && (
                            ...
                            {filteredOptions.length === 0 ? (
                                ...
                                filteredOptions.map((option, index) => (
                                    <div
                                        key={option.value}
                                        className={cn(
                                            "relative flex cursor-pointer select-none items-center rounded-sm px-3 py-2 text-sm outline-none transition-all duration-200 hover:bg-accent hover:text-accent-foreground hover:pl-4 animate-fade-in",
                                            isSelected(option.value) && "bg-primary text-primary-foreground font-medium",
