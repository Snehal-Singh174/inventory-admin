    ...
    "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
    {
        variants: {
            variant: {
                ...
                outline: "border-2 border-input hover:bg-accent hover:text-accent-foreground hover:border-primary hover:shadow-md active:scale-95",
                ...
                warning: "bg-warning text-warning-foreground hover:bg-warning/90 hover:shadow-lg hover:scale-105 active:scale-95",
                danger: "bg-error text-error-foreground hover:bg-error/90 hover:shadow-lg hover:scale-105 active:scale-95",
            },
            size: {
